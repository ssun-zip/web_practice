...
<!--    jsp:useBean 을 사용하여, 객체 생성 후 setProperty로 데이터를-->      
	<jsp:useBean id = "m" class = "sec1215.MemberBean2" scope = "page"/>
   ...
   <%
    ...
    List membersList = memberDAO.listMembers(); // 전체 회원정보를 조회합니다. 
